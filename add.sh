...
gsutil -h "Cache-Control:public, max-age=2592000" cp -r -Z ./css gs://www.ryanwkoch.com/css/

gsutil -h "Cache-Control:public, max-age=2592000" cp -r -Z ./img gs://www.ryanwkoch.com/img/

gsutil -h "Cache-Control:public, max-age=2592000" cp -r -Z ./lib gs://www.ryanwkoch.com/lib/
